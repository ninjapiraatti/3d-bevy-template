...
fn spawn_npcs(
    ...
    spawns: Query<(Entity, &GlobalTransform), (With<NpcSpawn>, Without<NpcSpawned>)>,
            ...
            .with_children(|parent| {
                ...
                parent.spawn((
                    ...
                    WorldAssetRoot(assets.load(
                        GltfAssetLabel::Scene(0).from_asset("characters/adventurers/Barbarian.glb"),
                    )),
